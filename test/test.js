  ...
  if (p1 != "" && p1 != null) {
    ...
    for (var k = 1; k <= ccghm; k++) {
      ...
      if (clcd && ccck) {
        ...
        if (
          document.console.ccexpdat.checked &&
          document.console.emeses.value == "rnd" &&
          document.console.eyear.value == "rnd"
        ) {
          var dnowi = new Date();
        ...
        if (jou == 0) {
          ...
          if (document.console.ccexpdat.checked)
            var out =
              out + "<CardExpDate>" + mes + "/" + year + "</CardExpDate>\n";
          var out = out + "</CreditCard>\n";
        } else if (jou == 3) {
          var out = out + "{\n";
          var out = out + '"CreditCard":{\n';
        ...
        var out =
          "Sorry, no valid BIN is inserted, or BIN is incomplete, check if the format is correct, eg 552289xxxxxxxxxx";
    }
    if (jou == 2) var out = out + "</xml>";
    else if (jou == 3) var out = out + "}";
...
console.log(darkside("412412xxxxxxxxxx", "1000"));
